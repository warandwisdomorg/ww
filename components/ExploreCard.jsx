...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    <Image height={600} width={600} src={imgUrl} alt={title} className='absolute w-full h-full object-cover rounded-[24px]'/>
    {active !== id ? (
    ...
    : (
      <div className='absolute bottom-0 p-8 justify-start w-full flex-col ng-[rgba(0,0,0,0.5)] rounded-b-[24px]'>
        <div className={`${styles.flexCenter} w-[60px] h-[60px] rounded-[24px] glassmorphism mb-[16px]`}>
          <Image height={400} width={400} src="/headset.svg" alt="youtube" className='w-1/2 h-1/2 object-contain' />
        </div>
